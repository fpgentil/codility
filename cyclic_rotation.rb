...
# each element is shifted right by one index, and the last element of the array is moved to the
...
#     def solution(a, k)
#
# that, given a zero-indexed array A consisting of N integers and an integer K, returns the array
# A rotated K times.
#
# For example, given
#     A = [3, 8, 9, 7, 6]
